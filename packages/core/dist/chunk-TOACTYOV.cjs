...
function getDefaultTelemetryConfig() {
  return {
    enabled: true,
    host: safeGetEnv("WARPJS_TELEMETRY_ENDPOINT") || "https://stats.warpcms.com",
    debug: safeGetEnv("NODE_ENV") === "development"
  };
}
function isTelemetryEnabled() {
  const telemetryEnv = safeGetEnv("WARPJS_TELEMETRY");
...
//# sourceMappingURL=chunk-TOACTYOV.cjs.map
//# sourceMappingURL=chunk-TOACTYOV.cjs.map