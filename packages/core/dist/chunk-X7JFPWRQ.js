...
var package_default = {
  name: "@warpcms/core",
  version: "2.8.0",
  description: "Core framework for WarpCMS headless CMS - Edge-first, TypeScript-native CMS built for Cloudflare Workers",
  type: "module",
  main: "./dist/index.cjs",
  module: "./dist/index.js",
  types: "./dist/index.d.ts",
  bin: {
    "warpcms-db-reset": "./bin/db-reset.js",
  ...
  repository: {
    type: "git",
    url: "git+https://github.com/badmuriss/warpcms.git",
    directory: "packages/core"
  },
  bugs: {
    url: "https://github.com/badmuriss/warpcms/issues"
  },
  homepage: "https://github.com/badmuriss/warpcms",
  peerDependencies: {
...
var WARPJS_VERSION = package_default.version;
var SONICJS_VERSION = package_default.version;
function getWarpCMSVersion() {
...
export { QueryFilterBuilder, SONICJS_VERSION, TemplateRenderer, WARPJS_VERSION, buildQuery, escapeHtml, generateSlug, getBlocksFieldConfig, getCoreVersion, getWarpCMSVersion, package_default, parseBlocksValue, renderTemplate, sanitizeInput, sanitizeObject, templateRenderer };
//# sourceMappingURL=chunk-X7JFPWRQ.js.map
//# sourceMappingURL=chunk-X7JFPWRQ.js.map