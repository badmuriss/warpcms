...
function renderLogo(data = {}) {
  ...
  const logoSvg = `
    <span class="${sizeClass} ${className} font-bold tracking-tight ${variant === "white" ? "text-white" : variant === "dark" ? "text-gray-800" : "text-cyan-400"}" style="font-size: ${size === "sm" ? "1.25rem" : size === "md" ? "1.5rem" : size === "lg" ? "2rem" : "2.5rem"}">WarpCMS</span>
  `;
...
//# sourceMappingURL=chunk-4IO5UBHK.cjs.map
//# sourceMappingURL=chunk-4IO5UBHK.cjs.map