...
var PluginManager = class {
  ...
  async initialize(context) {
    ...
    await this.hooks.execute(chunkZN756PME_cjs.HOOKS.APP_INIT, {
      pluginManager: this,
      context
    });
  ...
  async install(plugin, config) {
    ...
    try {
      ...
      await this.hooks.execute(chunkZN756PME_cjs.HOOKS.PLUGIN_INSTALL, {
        plugin: plugin.name,
        version: plugin.version,
  ...
  async uninstall(name) {
    ...
    try {
      ...
      await this.hooks.execute(chunkZN756PME_cjs.HOOKS.PLUGIN_UNINSTALL, {
        plugin: name,
        context: pluginContext
      });
  ...
  async shutdown() {
    ...
    await this.hooks.execute(chunkZN756PME_cjs.HOOKS.APP_SHUTDOWN, {
      pluginManager: this
    });
...
var manifest_default = {
  ...
  repository: "https://github.com/badmuriss/warpcms",
  license: "MIT",
...
//# sourceMappingURL=chunk-DWM25XXY.cjs.map
//# sourceMappingURL=chunk-DWM25XXY.cjs.map