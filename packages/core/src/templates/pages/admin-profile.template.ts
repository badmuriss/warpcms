...
export function renderProfilePage(data: ProfilePageData): string {
  ...
  const pageContent = `
    <div class="space-y-8">
      ...
      <div class="sm:flex sm:items-center sm:justify-between">
        <div>
          <h1 class="text-2xl/8 font-semibold text-zinc-950 dark:text-white sm:text-xl/8">${t('users.form.userProfile', locale)}</h1>
          <p class="mt-2 text-sm/6 text-zinc-500 dark:text-zinc-400">
            ${t('users.form.manageAccountSettings', locale)}
          </p>
        </div>
      </div>
      ...
      <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10">
            ...
            <div class="px-6 py-5 border-b border-zinc-950/5 dark:border-white/5">
              <div class="flex items-center gap-x-3">
                ...
                <div>
                  <h2 class="text-base font-semibold text-zinc-950 dark:text-white">${t('users.form.profileInformation', locale)}</h2>
                  <p class="text-sm text-zinc-500 dark:text-zinc-400">${t('users.form.updateAccountDetails', locale)}</p>
                </div>
              </div>
            </div>
            ...
            <form id="profile-form" hx-put="/admin/profile" hx-target="#form-messages" class="p-6 space-y-6">
              ...
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <input
                    ...
                    placeholder="${t('users.form.enterYourFirstName', locale)}"
                  >
                </div>
                <div>
                  ...
                  <input
                    ...
                    required
                    class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
                    placeholder="${t('users.form.enterYourLastName', locale)}"
                  >
                </div>
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  required
                  class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
                  placeholder="${t('users.form.enterYourUsername', locale)}"
                >
              </div>

              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.emailAddress', locale)}</label>
                <input
                  type="email"
                  name="email"
                  ...
                  required
                  class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
                  placeholder="${t('users.form.enterYourEmail', locale)}"
                >
              </div>

              <div>
                <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.phoneNumber', locale)}</label>
                <input
                  type="tel"
                  name="phone"
                  value="${data.profile.phone || ''}"
                  class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
                  placeholder="${t('users.form.enterYourPhone', locale)}"
                >
              </div>
              ...
              <div>
                ...
                <textarea
                  ...
                  placeholder="${t('users.form.tellUsAboutYourself', locale)}"
                >${data.profile.bio || ''}</textarea>
              </div>

              <!-- Preferences -->
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.form.preferences', locale)}</h3>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div>
                    <label for="timezone" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.timezone', locale)}</label>
                  ...
                  <div>
                    <label for="language" class="block text-sm/6 font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.language', locale)}</label>
                    <div class="grid grid-cols-1">
              ...
              <!-- Notifications -->
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.form.notifications', locale)}</h3>
                ...
                <div class="space-y-5">
                  <div class="flex gap-3">
                    ...
                    <div class="text-sm/6">
                      <label for="email_notifications" class="font-medium text-zinc-950 dark:text-white">${t('users.form.emailNotifications', locale)}</label>
                      <p class="text-zinc-500 dark:text-zinc-400">${t('users.form.emailNotificationsDesc', locale)}</p>
                    </div>
                  </div>
                </div>
              </div>
              ...
              <div class="pt-6 border-t border-zinc-950/5 dark:border-white/5">
                ...
                >
                  ...
                  ${t('users.form.updateProfile', locale)}
                </button>
              </div>
            </form>
          </div>
        ...
        <div class="lg:col-span-1 space-y-6">
          ...
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.form.profilePicture', locale)}</h3>
            ...
            <div class="text-center">
              ...
              <form id="avatar-form" hx-post="/admin/profile/avatar" hx-target="#avatar-messages" hx-encoding="multipart/form-data">
                ...
                >
                  ...
                  ${t('users.form.changePicture', locale)}
                </label>
              </form>
          ...
          <!-- Account Info -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.form.accountInformation', locale)}</h3>

            <dl class="space-y-3 text-sm">
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('users.form.role', locale)}</dt>
                <dd class="mt-1">
              ...
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('users.form.memberSince', locale)}</dt>
              ...
              ` : ''}
              <div>
                <dt class="text-zinc-500 dark:text-zinc-400">${t('users.form.twoFactorAuth', locale)}</dt>
                <dd class="mt-1">
                  ${data.profile.two_factor_enabled
                    ? `<span class="inline-flex items-center rounded-md bg-green-50 dark:bg-green-500/10 px-2 py-1 text-xs font-medium text-green-700 dark:text-green-400 ring-1 ring-inset ring-green-600/20 dark:ring-green-500/20">${t('users.form.enabled', locale)}</span>`
                    : `<span class="inline-flex items-center rounded-md bg-zinc-50 dark:bg-zinc-800 px-2 py-1 text-xs font-medium text-zinc-600 dark:text-zinc-400 ring-1 ring-inset ring-zinc-500/10 dark:ring-zinc-400/20">${t('users.form.disabled', locale)}</span>`
                  }
                </dd>
              </div>
            </dl>
          ...
          <!-- Security Actions -->
          <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-sm ring-1 ring-zinc-950/5 dark:ring-white/10 p-6">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white mb-4">${t('users.form.security', locale)}</h3>
            ...
            <div class="space-y-2">
              ...
              >
                ...
                <span class="font-medium">${t('users.form.changePassword', locale)}</span>
              </button>
              ...
              >
                ...
                <span class="font-medium">${data.profile.two_factor_enabled ? t('users.form.disable2fa', locale) : t('users.form.enable2fa', locale)}</span>
              </button>
            </div>
          </div>
        </div>
      ...
      <div class="rounded-xl bg-white dark:bg-zinc-900 shadow-2xl ring-1 ring-zinc-950/5 dark:ring-white/10 w-full max-w-md mx-4">
        <div class="px-6 py-5 border-b border-zinc-950/5 dark:border-white/5">
          <div class="flex items-center justify-between">
            <h3 class="text-base font-semibold text-zinc-950 dark:text-white">${t('users.form.changePassword', locale)}</h3>
        ...
        <form id="password-form" hx-post="/admin/profile/password" hx-target="#password-messages" class="p-6 space-y-4">
          ...
          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.currentPassword', locale)}</label>
            <input
              type="password"
              name="current_password"
              required
              class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
              placeholder="${t('users.form.enterCurrentPassword', locale)}"
            >
          </div>

          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.newPassword', locale)}</label>
            <input
              type="password"
              name="new_password"
              required
              minlength="8"
              class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
              placeholder="${t('users.form.enterNewPassword', locale)}"
            >
            <p class="mt-1 text-xs text-zinc-500 dark:text-zinc-400">${t('users.form.passwordMinLength', locale)}</p>
          </div>

          <div>
            <label class="block text-sm font-medium text-zinc-950 dark:text-white mb-2">${t('users.form.confirmNewPassword', locale)}</label>
            <input
              type="password"
              ...
              minlength="8"
              class="w-full rounded-lg bg-white dark:bg-zinc-800 px-3 py-2 text-sm text-zinc-950 dark:text-white shadow-sm ring-1 ring-inset ring-zinc-950/10 dark:ring-white/10 placeholder:text-zinc-400 dark:placeholder:text-zinc-500 focus:outline-none focus:ring-2 focus:ring-zinc-950 dark:focus:ring-white transition-shadow"
              placeholder="${t('users.form.confirmNewPasswordPlaceholder', locale)}"
            >
          </div>
          ...
          <div class="flex justify-end gap-x-3 pt-4 border-t border-zinc-950/5 dark:border-white/5">
            ...
            >
              ...
              ${t('users.form.updatePassword', locale)}
            </button>
          </div>
        </form>
      </div>
    ...
    <script>
      ...
      function toggle2FA() {
        alert(window.__i18n.twoFaComingSoon);
      }
  ...
  const layoutData: AdminLayoutCatalystData = {
    title: t('users.form.userProfile', locale),
    pageTitle: t('users.form.userProfile', locale),
