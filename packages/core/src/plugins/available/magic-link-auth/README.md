...
Passwordless authentication for WarpCMS via email magic links. Users sign in by clicking a secure one-time link sent to their email - no password required.
...
- ✅ **Email Integration**: Uses WarpCMS email plugin (Resend)
...
The plugin is included with WarpCMS but inactive by default.
