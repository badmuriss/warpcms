...
import { renderTemplate } from '@warpcms/core';
...
export class EmailTemplateRenderer {
  ...
  static getDummyVariables(): EmailVariables {
    return {
      ...
      // Content specific
      content: {
        title: 'Getting Started with WarpCMS AI',
        url: 'https://example.com/content/123',
        excerpt: 'Learn how to build amazing web applications with WarpCMS AI...',
      },
      ...
      replyToEmail: 'support@warpcms.com',
    };
  }
}
