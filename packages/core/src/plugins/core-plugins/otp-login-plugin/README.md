...
Passwordless authentication for WarpCMS via email one-time codes (OTP). Users sign in by entering a 6-digit code sent to their email - no password required.
...
- ✅ **Email Integration**: Uses WarpCMS email plugin
